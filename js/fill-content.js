				...
				function fillTable22(){
					...
					var table = new Tabulator("#m2-example-table", {
					 	...
					 	columns:[ //Define Table Columns
						 	...
						 	{title:colHeaders[3], field:colHeaders[3], width: 120, formatter: "textarea"},
						 	{title:colHeaders[4], field:colHeaders[4], width: 120, formatter: "textarea"},
						 	{title:colHeaders[5], field:colHeaders[5], width: 120, formatter: "textarea"},
						 	{title:colHeaders[6], field:colHeaders[6], width: 120, formatter: "textarea"},
						 	{title:colHeaders[7], field:colHeaders[7], width: 120, formatter: "textarea"},
						 	{title:colHeaders[8], field:colHeaders[8], width: 120, formatter: "textarea"},
						 	{title:colHeaders[9], field:colHeaders[9], width: 120, formatter: "textarea"},
						 	{title:colHeaders[10], field:colHeaders[10], width: 120, formatter: "textarea"},
						 	{title:colHeaders[11], field:colHeaders[11], width: 120, formatter: "textarea"},
						 	{title:colHeaders[12], field:colHeaders[12], width: 120, formatter: "textarea"},
						 	{title:colHeaders[13], field:colHeaders[13], width: 120, formatter: "textarea"},
						 	{title:colHeaders[14], field:colHeaders[14], width: 120, formatter: "textarea"},
						 	{title:colHeaders[15], field:colHeaders[15], width: 120, formatter: "textarea"}, 
						 	{title:colHeaders[16], field:colHeaders[16], width: 120, formatter: "textarea"},
						 	{title:colHeaders[17], field:colHeaders[17], width: 120, formatter: "textarea"},
						 	{title:colHeaders[18], field:colHeaders[18], width: 120, formatter: "textarea"},
						 	{title:colHeaders[19], field:colHeaders[19], width: 120, formatter: "textarea"}
					 	],
